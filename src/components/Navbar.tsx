...
export default function Navbar() {
    ...
    return (
        <div className="font-bold flex justify-between items-center w-screen px-4 md:px-10 lg:px-20 pt-4 text-lg">
            <img src="/dribbble.jpg" alt="" className="h-10 w-28 md:h-16 md:w-48" />
            ...
            <div className="flex gap-4 md:gap-8 items-center">
                ...
                <button className="bg-pink-600 text-white text-sm font-semibold rounded-full px-3 md:px-5 py-2.5">Get Started</button>
                {
